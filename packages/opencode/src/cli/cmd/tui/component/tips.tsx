...
const TIPS = [
  ...
  "TechnocodeX auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "TechnocodeX auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "TechnocodeX uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent TechnocodeX from reading sensitive files",
  ...
  "Use {highlight}/connect{/highlight} with TechnocodeX Zen for curated, tested models",
